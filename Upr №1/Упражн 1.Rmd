...
inTrain <-  sample(seq_along(x), size = train.percent*n.all)
  ...
  y.func <- function(x) {12 + 3.5*sin((x-30)/9)}
...
## Так как *res.sd* является показателем стандартного отклонения случайного шума, то величина MSE: среднеквадратическая ошибка модели, зависит от нее прямо пропорционально.